...
class Barang_m extends CI_Model {
    ...
    var $column_order = array(null, 'kode_barang', 'nama_barang', 'nama_suplier', 'kategori','harga', 'jenis', 's' , 'm' , 'l' , 'xl' , 'xxl' , 'xxxl' , 'xxxxl'); //set column field database for datatable orderable
