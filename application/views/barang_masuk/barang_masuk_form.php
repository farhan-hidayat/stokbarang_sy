        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <a href="<?=site_url('barang_masuk')?>" class="btn btn-warning btn-flat">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form action="<?=site_url('barang_masuk/process')?>" method="post">
                                        <div class="form-group">
                                            <input type="text" value="<?=$this->fungsi->user_login()->nama?>" class="form-control" readonly>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="number" name="s_m" value="<?=$row->s_m?>" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>S</label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <label>M(29)</label>
                                                    <input type="number" name="m_m" value="<?=$row->m_m?>" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>M</label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <label>L(30)</label>
                                                    <input type="number" name="l_m" value="<?=$row->l_m?>" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>L</label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <label>XL(31)</label>
                                                    <input type="number" name="xl_m" value="<?=$row->xl_m?>" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>XL</label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <label>XXL(32)</label>
                                                    <input type="number" name="xxl_m" value="<?=$row->xxl_m?>" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>XXL</label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <label>3L(33)</label>
                                                    <input type="number" name="xxxl_m" value="<?=$row->xxxl_m?>" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>3L</label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <label>4L(34)</label>
                                                    <input type="number" name="xxxxl_m" value="<?=$row->xxxxl_m?>" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>4L</label>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <label>5L(35)</label>
                                                    <input type="number" name="xxxxxl_m" value="<?=$row->xxxxxl_m?>" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>5L</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime" name="tanggal_masuk" value="<?=date('Y-m-d H-i-s')?>" class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
